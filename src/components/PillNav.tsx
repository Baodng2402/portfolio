...
const PillNav: React.FC<PillNavProps> = ({
  ...
  // IntersectionObserver for auto-highlighting active section
  useEffect(() => {
    if (!enableAutoHighlight) return;
  ...
  return (
    <div className="fixed top-6 z-[1000] w-full left-0 md:w-auto md:left-auto px-4 md:px-0">
      <nav
