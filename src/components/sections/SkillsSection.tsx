    ...
    <Section id="skills" variant="grid">
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-2">
        {skillGroups.map((group) => (
          <div key={group.label} className="skill-group glass-card p-5 md:p-6">
            <h3 className="font-mono text-xs font-semibold uppercase tracking-widest text-[var(--color-accent)]">
              {group.label}
            </h3>
            <div className="mt-5 grid grid-cols-3 gap-x-3 gap-y-5 sm:grid-cols-4 md:grid-cols-3 xl:grid-cols-4">
